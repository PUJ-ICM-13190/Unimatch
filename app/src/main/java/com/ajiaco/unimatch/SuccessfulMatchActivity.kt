...
import com.ajiaco.unimatch.MatchmakingFragment
...
class SuccessfulMatchActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val user2Name = intent.getStringExtra("USER2_NAME")
        ...
        fun sendMessage() {
            ...
            if (message.isNotEmpty()) {
                ...
                createNewChatWithMessage(message, user2ImageUrl,user2Name )//esto es nuevo
    ...
    //esto es nuevo
    private fun createNewChatWithMessage(
        message: String,
        ...
        // Aquí es donde se crea un nuevo chat
        val newChat = Chat(
            userName = user2Name.toString(),  // Aquí puedes usar el nombre de usuario emparejado
            lastMessage = message,
            timeStamp = minutes,
            userProfilePicUrl = user2ImageUrl.toString()  // URL de la foto del usuario
        )

        // Guardar el chat en el repositorio
